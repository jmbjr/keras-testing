...
def runit(thing_set, thing_classes, train_basesize, valid_basesize, test_basesize):

    train_path = 'cnn/{}/train'.format(thing_set)
    valid_path = 'cnn/{}/valid'.format(thing_set)
    test_path = 'cnn/{}/test'.format(thing_set)

    print('current directory {}'.format(os.getcwd()))
    for paths in [train_path, valid_path, test_path]:
        filecount = sum([len(files) for r, d, files in os.walk(paths)])
        print('found {} files in {}'.format(filecount, paths))
...
if __name__ == "__main__":
    ...
    runit(thing_set, thing_classes, train_basesize, valid_basesize, test_basesize)